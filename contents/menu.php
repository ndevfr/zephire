...
if (!$detect->isMobile() || $detect->isTablet()) {
    if (estprof()) {
        ...
        if (estadmin()) {
            ...
            echo "'><a href='mdfniveaux.php'>Niveaux</a></li>";
            // Page "Modifier les professeurs"
            echo "<li class='page_item";
            if ($pageaff == "mdfprofs.php") {
                echo " child-active child-Selected";
            }
            echo "'><a href='mdfprofs.php'>Professeurs</a></li>";
            // Page "Modifier les disciplines"
            echo "<li class='page_item";
            if ($pageaff == "mdfdisciplines.php") {
                echo " child-active child-Selected";
            }
            echo "'><a href='mdfdisciplines.php'>Disciplines</a></li>";
            // Page "Modifier les classes"
            echo "<li class='page_item";
            if ($pageaff == "mdfclasses.php") {
                echo " child-active child-Selected";
            }
            echo "'><a href='mdfclasses.php'>Classes</a></li>";
            // Page "Modifier les eleves"
            echo "<li class='page_item";
            if ($pageaff == "mdfeleves.php") {
                echo " child-active child-Selected";
            }
            echo "'><a href='mdfeleves.php'>El&egrave;ves</a></li>";
        }
        ...
        echo "'><a href='mdfprogressions.php'>Progressions</a></li>";
        // Page "Modifier les competences"
        echo "<li class='page_item";
        if ($pageaff == "mdfcompetences.php") {
            echo " child-active child-Selected";
        }
        echo "'><a href='mdfcompetences.php'>Comp&eacute;tences</a></li>";
        if (estadmin()) {
