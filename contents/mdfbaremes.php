...
if ((!empty($classe)) && (!empty($discipline)) && (!empty($chapitre))) {
    ...
    echo "<form action='mdfbaremes.php?idcl=" . $classe . "&amp;idds=" . $discipline . "&amp;idch=" . $chapitre . "' method='POST'><p>Pour chaque compétence, indiquer les points qui lui sont attribuée.</p><table class='data large'><thead><tr><th>Nom</th><th style='width:50px;'>Barème</th></tr></thead><tbody>";
