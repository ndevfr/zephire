...
if ( $modech == 0 ) {
	...
	foreach ( $codes as $cd ) {
		if ( $cd !== "" ) {
			echo "<tr><td>" . donnelib( $cd, $classe, $discipline, $modech ) . "</td><td style='padding-left:5px;padding-right:5px;'>" . enimage( $cd, $classe, $discipline, $modech ) . "</td><td style='text-align:left;text-align:left;width:100%;'>" . donnedesc( $cd, $classe, $discipline, $modech );
			if ( $notech ) {
				echo " J'obtiens " . donnenota( $cd, $classe, $discipline ) . " % des points.";
			}
			echo "</td></tr>";
		}
	}
